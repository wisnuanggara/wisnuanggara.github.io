...
function showAboutIntroductionTexts() {
  if (!aboutSectionEntered) {
    new Typed("#work", {
      strings: [
        "I'm a technology @ <span class = 'colCurrentlyor-primary'>enthusiast</span>",
      ],
      typeSpeed: 20,
      loop: false,
      startDelay: 0,
      ...
      onComplete: function () {
        new Typed(".office-text", {
          strings: [
            "I like to make mobile-based applications, especially <span class = 'color-primary'>iOS</span> app.",
          ],
          typeSpeed: 18,
          loop: false,
          startDelay: 0,
            ...
            new Typed(".spare-text", {
              ...
              onComplete: function () {
                new Typed(".language-text", {
                  strings: [
                    "I code in <span class = 'color-palatte-1'>Swift</span>, <span class = 'color-palatte-1'>SWIFT UI</span>, <span class = 'color-palatte-1'>Python</span>, and <span class = 'color-palatte-1'>css</span>.",
                  ],
                  typeSpeed: 18,
                  loop: false,
                  startDelay: 0,
                  ...
                  onComplete: function () {
                    new Typed(".hobby-text", {
                      ...
                      onComplete: function () {
                        new Typed(".game-text", {
                          strings: [
                            "I also enjoy occasional gaming, my favorites being <span class = 'color-palatte-5'>PRO EVOLUTION SOCCER</span> and <span class = 'color-palatte-5'>FIFA</span>",
                          ],
                          typeSpeed: 18,
                          loop: false,
                          startDelay: 0,
                          ...
                          onComplete: function () {
                            new Typed(".contribution-text", {
                              strings: [
                                "I've recently created an <a href='https://www.instagram.com/wisnuuanggaraa/' target='_blank'><span class = 'color-palatte-4'> Instagram</span></a> handle to share my knowledge, connect with awesome people, and help other developers with iOS dev.",
                              ],
                              typeSpeed: 18,
                              loop: false,
                              startDelay: 0,
